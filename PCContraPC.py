...
def renderizar_botoes(reg):
    ...
    liga_led_verde = ["a","c","e","g","i","k","m","o","q"]
    liga_led_azul  = ["b","d","f","h","j","l","n","p","r"]
...
def ganhei_comemoracao(posicao):
    global reg
    global vez
    sleep(0.1)
    for num in range(0,10):
...
def deu_velha_comemoracao():
    ...
    for num in range(0,8):
        reg = ['x','x','x','x','x','x','x','x','x']
        renderizar_botoes(reg)
        sleep(0.2)

        reg = ['o','o','o','o','o','o','o','o','o']
        renderizar_botoes(reg)
        sleep(0.2)
