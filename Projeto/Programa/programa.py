...
while True:
    ...
    status = Ia.ganhou(vez,reg,velha)
    if status[0] =='vitória':
        lista = ['sons/perdeu/errou.mp3','sons/perdeu/quartetofantastico__risadasaltas.wav','sons/perdeu/219876__polmdx__buu-loser-shout.mp3','sons/perdeu/353550__nicksta18__evil-laugh-1.mp3','sons/perdeu/321909__bboyjoe-15__fatality.mp3','sons/perdeu/219110__zyrytsounds__evil-laugh.wav']
        toque = choice(lista)
        play(toque)
